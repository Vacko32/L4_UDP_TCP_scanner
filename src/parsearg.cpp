...
void Args::printhelp(){
        ...
        cout << "                         (If no value specified, the list of interfaces will be printed)" << endl;
        cout << "  -t <ports> OR --pt <ports>                  Set TCP port ranges (e.g., --pt 22 for SSH port)" << endl;
        cout << "  -u <ports> OR --pu <ports>             Set UDP port ranges (e.g., --pu 1-65535 for all UDP ports)" << endl;
